...
/// Extend outwards from the point, selecting neighbours that are in the slice
/// and haven't been seen.
fn extend(point: &Point, closed: &[Point]) -> Vec<Point> {
    point
        .neighbours()
        .into_iter()
...
///
/// From this slice, rotational reflections are made to generate the entire
/// snowflake.
